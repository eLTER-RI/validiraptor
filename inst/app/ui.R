           ...
           tabPanel(id = 'tabInput', title = 'main',
                    ...
                    fluidRow(
                        ...
                        column(8,
                               ...
                               div(id = 'alertWrongSeparator', class = 'alert alert-warning',
                                   'please make sure to use', textOutput('sep', inline = TRUE), ' as column separator'
                                   ),
                               div(id = 'alertNoSchema', class = 'alert alert-warning',
